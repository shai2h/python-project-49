from brain_games.utils import get_random_number, is_game_complete, get_user_answer
...
def brain_prime(name):
    ...
    while is_game_complete(target_score, target_score_needed):
        ...
        if (user_answer == yes_answer and prime_number == True) or (user_answer == no_answer and prime_number == False):
            print('Correct!')
            target_score += 1
        else:
